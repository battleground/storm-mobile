package com.baofeng.mobile.util;
...
/**
 * 一个工具类
 * 用来负责显示和隐藏system UI，例如顶部状态栏、底部导航栏。
 * 该类采用向后兼容方式，确保可以运行在android系统的任何版本上。
 * getInstance()方法在较新的系统版本上返回SystemUiHiderHoneycomb实例，
 * 低版本系统返回SystemUiHiderBase实例。
 *
 *
