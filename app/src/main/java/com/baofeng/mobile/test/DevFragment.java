 ...
 * on 15-7-23.
 */
public class DevFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ViewHolder.OnRecyclerItemClickListener {

    private static DevPresenter mPresenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewAdapter<Image>(){
            ...
            public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                return new DevViewHolder(v, DevFragment.this);
            }
